...
<body>
    <div class="container">
        ...
        <div style="text-align: center;">(该数据有十分钟以内的延迟)</div>
...
# 构建 HTML2 内容
html_content2 = f"""更新日期: {formatted_date} | 更新哈希值: <a href="{commit_url}">{commit_sha_short}</a><br/><div style="text-align: center;">(该数据有十分钟以内的延迟)</div>
"""
